    ...
    var e = {
        ...
        717: function(e, t, n) {
            ...
            function issueCommand(e, t) {
                ...
                r.appendFileSync(n, `${o.toCommandValue(t)}${s.EOL}`, {
                    encoding: "utf8"
                })
            }
            t.issueCommand = issueCommand
        ...
        514: function(e, t, n) {
            ...
            function exec(e, t, n) {
                return i(this, void 0, void 0, function*() {
                    const i = s.argStringToArray(e);
                    if (i.length === 0) {
                        throw new Error(`Parameter 'commandLine' cannot be null or empty.`)
                    }
                    const r = i[0];
                    t = i.slice(1).concat(t || []);
                    const o = new s.ToolRunner(r, t, n);
                    return o.exec()
                })
            }
            t.exec = exec
        ...
        159: function(e, t, n) {
            ...
            class ToolRunner extends o.EventEmitter {
                ...
                _processLineBuffer(e, t, n) {
                    try {
                        let i = t + e.toString();
                        let r = i.indexOf(s.EOL);
                        while (r > -1) {
                            const e = i.substring(0, r);
                            n(e);
                            i = i.substring(r + s.EOL.length);
                            r = i.indexOf(s.EOL)
                        }
                        t = i
                    } catch (e) {
                ...
                _getSpawnOptions(e, t) {
                    ...
                    n.cwd = e.cwd;
                    n.env = e.env;
                    n["windowsVerbatimArguments"] = e.windowsVerbatimArguments || this._isCmdFile();
                ...
                exec() {
                    return i(this, void 0, void 0, function*() {
                        if (!a.isRooted(this.toolPath) && (this.toolPath.includes("/") || f && this.toolPath.includes("\\"))) {
                        ...
                        return new Promise((e, t) => {
                            ...
                            if (!n.silent && n.outStream) {
                                n.outStream.write(this._getCommandString(n) + s.EOL)
                            }
                            const i = new ExecState(n, this.toolPath);
                            i.on("debug", e => {
                                this._debug(e)
                            });
                            const r = this._getSpawnFileName();
                            const o = u.spawn(r, this._getSpawnArgs(n), this._getSpawnOptions(this.options, r));
                            const c = "";
                            if (o.stdout) {
                                o.stdout.on("data", e => {
                            ...
                            if (o.stderr) {
                                o.stderr.on("data", e => {
                                    ...
                                    if (!n.silent && n.errStream && n.outStream) {
                                        const t = n.failOnStdErr ? n.errStream : n.outStream;
                                        t.write(e)
                                    }
        ...
        962: function(e, t, n) {
            ...
            const o = n(747);
            const u = n(622);
            r = o.promises, t.chmod = r.chmod, t.copyFile = r.copyFile, t.lstat = r.lstat, t.mkdir = r.mkdir, t.readdir = r.readdir, t.readlink = r.readlink, t.rename = r.rename, t.rmdir = r.rmdir, t.stat = r.stat, t.symlink = r.symlink, t.unlink = r.unlink;
            ...
            t.exists = exists;
            function isDirectory(e, n = false) {
                return i(this, void 0, void 0, function*() {
                    const i = n ? yield t.stat(e): yield t.lstat(e);
            ...
            t.isRooted = isRooted;
            function mkdirP(e, n = 1e3, r = 1) {
                return i(this, void 0, void 0, function*() {
                    s.ok(e, "a path argument must be provided");
                    e = u.resolve(e);
                    if (r >= n) return t.mkdir(e);
                    try {
                        yield t.mkdir(e);
                        return
                    } catch (i) {
                        switch (i.code) {
                            case "ENOENT": {
                                yield mkdirP(u.dirname(e), n, r + 1);
                                yield t.mkdir(e);
                                return
                            }
                            default: {
            ...
            t.mkdirP = mkdirP;
            function tryGetExecutablePath(e, n) {
                return i(this, void 0, void 0, function*() {
                    let i = undefined;
                    try {
                        i = yield t.stat(e)
                    ...
                    for (const s of n) {
                        ...
                        if (i && i.isFile()) {
                            if (t.IS_WINDOWS) {
                                try {
                                    const n = u.dirname(e);
                                    const i = u.basename(e).toUpperCase();
                                    for (const r of yield t.readdir(n)) {
                                        if (i === r.toUpperCase()) {
                                            e = u.join(n, r);
                                            break
                                        }
        ...
        436: function(e, t, n) {
            ...
            function cp(e, t, n = {}) {
                return i(this, void 0, void 0, function*() {
                    ...
                    const o = (yield u.exists(t)) ? yield u.stat(t): null;
                    if (o && o.isFile() && !i) {
                        return
                    }
            ...
            function which(e, t) {
                return i(this, void 0, void 0, function*() {
                    ...
                    try {
                        ...
                        if (u.isRooted(e)) {
                            const n = yield u.tryGetExecutablePath(e, t);
                            if (n) {
                                return n
                            }
                            return ""
                        }
                        if (e.includes("/") || u.IS_WINDOWS && e.includes("\\")) {
                            return ""
                        }
                        const n = [];
                        if (process.env.PATH) {
                        ...
                        for (const i of n) {
                            const n = yield u.tryGetExecutablePath(i + s.sep + e, t);
                            if (n) {
                                return n
                            }
                        }
            ...
            function readCopyOptions(e) {
                ...
                const n = Boolean(e.recursive);
                return {
                    force: t,
                    recursive: n
                }
            }
            function cpDirRecursive(e, t, n, r) {
                return i(this, void 0, void 0, function*() {
                    if (n >= 255) return;
                    n++;
                    yield mkdirP(t);
                    const i = yield u.readdir(e);
                    for (const s of i) {
                        const i = `${e}/${s}`;
                        const o = `${t}/${s}`;
                        const c = yield u.lstat(i);
                        if (c.isDirectory()) {
                            yield cpDirRecursive(i, o, n, r)
                        } else {
                            yield copyFile(i, o, r)
                        }
                    }
            ...
            function copyFile(e, t, n) {
                return i(this, void 0, void 0, function*() {
                    if ((yield u.lstat(e)).isSymbolicLink()) {
                        ...
                        const n = yield u.readlink(e);
                        yield u.symlink(n, t, u.IS_WINDOWS ? "junction" : null)
                    } else if (!(yield u.exists(t)) || n) {
        ...
        144: function(e, t, n) {
            ...
            var s = this && this.__importStar || function(e) {
                ...
                if (e != null)
                    for (var n in e)
                        if (n !== "default" && Object.prototype.hasOwnProperty.call(e, n)) i(t, e, n);
                r(t, e);
                return t
            };
            ...
            var u = this && this.__generator || function(e, t) {
                var n = {
                        label: 0,
                        sent: function() {
                            if (s[0] & 1) throw s[1];
                ...
                function step(o) {
                    ...
                    while (n) try {
                        if (i = 1, r && (s = o[0] & 2 ? r["return"] : o[0] ? r["throw"] || ((s = r["return"]) && s.call(r), 0) : r.next) && !(s = s.call(r, o[1])).done) return s;
            ...
            var c = s(n(186));
            var l = s(n(514));
            var a = c.getInput("slither-slitherVersion") || "0.6.14";
            var f = c.getInput("run-npm-install") === "true";
            var d = parseInt(c.getInput("high-threshold")) || 1;
            var h = parseInt(c.getInput("medium-threshold")) || 1;
            var p = parseInt(c.getInput("low-threshold")) || 1;
            var m = parseInt(c.getInput("informative-threshold")) || 10;
            var g = parseInt(c.getInput("optimization-threshold")) || 1;
            var y = c.getInput("slither-params") || "";
            var w = c.getInput("projectPath") || ".";
            var v = function() {
                return o(void 0, void 0, void 0, function() {
                    ...
                    return u(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                t = r.sent();
                                c.setFailed("Something went wrong. Check above for more information");
                                return [2];
                            case 4:
                            ...
                            case 5:
                                ...
                                try {
                                    i = JSON.parse(n);
                                    if (!i.success) {
                                        c.setFailed("Something went wrong...");
                                        return [2]
                                    }
                                    ...
                                    console.log("----------------------------------------");
                                    (i.results.detectors || []).forEach(function(t) {
                                        var n = t.impact;
                                        e[n]++;
                                        c.error("[" + t.impact + "] " + t.check + ": " + t.description + "\n");
                                        console.log("[" + t.impact + "] " + t.check + ":");
                                        console.log(t.description);
                                        console.log("")
                                    });
                                    E(e)
                                } catch (e) {
                                    c.setFailed("Error parsing results");
                                    console.debug(e);
                                    return [2]
                                }
                                return [2]
            ...
            var b = function() {
                return o(void 0, void 0, void 0, function() {
                    return u(this, function(e) {
                        switch (e.label) {
                            case 0:
                                c.info("Install dependencies");
                                return [4, l.exec("sudo apt-get install -y git python3 python3-setuptools wget software-properties-common")];
                            case 1:
                                e.sent();
...
//                                 return [4, l.exec(" unzip /tmp/slither.zip -d .")];
                            ...
                            case 4:
                                e.sent();
                                if (!f) return [3, 6];
                                c.info("Installing dependencies");
                                return [4, l.exec("npm install", undefined, {
                                    cwd: w
                                })];
                            case 5:
                                e.sent();
            ...
            var _ = function() {
                c.debug("Configs:");
                c.debug("slitherVersion: " + a);
                c.debug("failOnHighResults: " + d);
                c.debug("failOnMediumResults: " + h);
                c.debug("failOnLowResults: " + p);
                c.debug("failOnInformativeResults: " + m);
                c.debug("failOnOptimizationResults: " + g);
                c.debug("projectPath: " + w);
                c.debug("runNpmInstall: " + f)
            };
            var S = function() {
                return o(void 0, void 0, void 0, function() {
                    return u(this, function(e) {
                        return [2, new Promise(function(e, t) {
                            ...
                            i.cwd = w;
                            l.exec("slither --json - . " + y, undefined, i).then(function() {
                                return e(n)
                            }).catch(function() {
                                return e(n)
                            })
            ...
            var E = function(e) {
                c.warning("Stats: High: " + e["High"] + ", Medium: " + e["Medium"] + ", Low: " + e["Low"] + ", Informative: " + e["Informational"] + ", Optimizations: " + e["Optimization"]);
                if (d !== 0 && d <= e["High"]) c.setFailed("Number of High results is equal or bigger then the defined threshold of " + d);
                else if (h !== 0 && h <= e["Medium"]) c.setFailed("Number of Medium results is equal or bigger then the defined threshold of " + h);
                else if (p !== 0 && p <= e["Low"]) c.setFailed("Number of Low results is equal or bigger then the defined threshold of " + p);
                else if (m !== 0 && m <= e["Informational"]) c.setFailed("Number of Informative results is equal or bigger then the defined threshold of " + m);
                else if (g !== 0 && g <= e["Optimization"]) c.setFailed("Number of Optimization results is equal or bigger then the defined threshold of " + g)
            };
            v()
        },
        357: e => {
